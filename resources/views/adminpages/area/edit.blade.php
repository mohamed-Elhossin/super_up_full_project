    ...
    <div class="register-box w-50">
        ...
        <div class="card">
            ...
            <div class="card-body register-card-body">
                <p class="login-box-msg"> اضافه مناطق جديد</p>
                ...
                <form method="POST" action="{{ route('area.update', $area->id) }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror " name="name"
                            value="{{ $area->name }}" placeholder="الاسم بالكامل">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select type="text" class="form-control @error('city_id') is-invalid @enderror " name="city_id">

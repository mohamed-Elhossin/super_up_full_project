                ...
                <form method="POST" action="{{ route('users.update' ,$user->id) }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror " name="name"
                            value="{{ $user->name }}" placeholder="الاسم بالكامل">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control @error('email') is-invalid @enderror " name="email"
                            value="{{ $user->email }}" placeholder="البريد الالكتروني">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <p for="">الصلاحيه </p>
                        <select type="password" class="form-control @error('rule') is-invalid @enderror" name="rule"
                            placeholder="الصلاحيه">
                            <option value="manager"> اداري </option>
